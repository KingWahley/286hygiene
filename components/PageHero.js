...
export default function PageHero({
  ...
  return (
    <section className={`relative ${sectionClassName}`}>
      ...
      <div className="mx-auto max-w-6xl rounded-[2.4rem] bg-[linear-gradient(135deg,_rgba(255,255,255,0.88)_0%,_rgba(205,238,244,0.84)_50%,_rgba(223,244,231,0.88)_100%)] p-[1px] shadow-[0_28px_70px_rgba(55,124,147,0.14)]">
        <div className="relative overflow-hidden rounded-[1.2rem] border border-white/70 bg-white/80 backdrop-blur">
          <Image     
            ...
            priority
          />
          <div className="absolute inset-0 bg-[linear-gradient(180deg,_rgba(9,30,42,0.08)_0%,_rgba(9,30,42,0.22)_100%)]" />
          <div className={`absolute inset-0 ${overlayClassName}`} />
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,_rgba(255,255,255,0.28),_transparent_30%),radial-gradient(circle_at_bottom_left,_rgba(255,255,255,0.16),_transparent_26%)]" />
          <div className="absolute inset-x-0 bottom-0 h-28 bg-[linear-gradient(180deg,_rgba(8,20,24,0)_0%,_rgba(8,20,24,0.18)_100%)]" />

          <div className={contentClassName}>
            <div className="max-w-[42rem] rounded-[1.8rem] border border-white/20 bg-[linear-gradient(180deg,_rgba(255,255,255,0.14)_0%,_rgba(255,255,255,0.08)_100%)] p-5 shadow-[0_20px_45px_rgba(8,35,44,0.16)] backdrop-blur-md sm:p-6">
